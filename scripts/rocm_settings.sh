...
ds4_rocm_apply_fast_full_defaults() {
  ...
  # COPY_MODEL stages the GGUF into a device (GTT on this APU) buffer. The copy is
  # chunked and releases each source page after upload (cuda_model_copy_chunked in
  ...
  export DS4_SERVER_ATTN_Q_B_CUBLAS="${DS4_SERVER_ATTN_Q_B_CUBLAS:-0}"  # Tier3: pruned (marginale ~2-3%, aggiunge deriva f16/hipBLASLt)
  ...
  export DS4_SERVER_Q8_WMMA_FAST="${DS4_SERVER_Q8_WMMA_FAST:-0}"  # Tier3: pruned (marginale ~2-3%, aggiunge deriva f16/hipBLASLt)
  export DS4_SERVER_Q8_WMMA_4W="${DS4_SERVER_Q8_WMMA_4W:-0}"  # Tier3: pruned (marginale ~2-3%, aggiunge deriva f16/hipBLASLt)
  ...
  export DS4_CUDA_SHARED_GATE_UP_BATCH_FUSED="${DS4_CUDA_SHARED_GATE_UP_BATCH_FUSED:-0}"  # Tier3: pruned (marginale ~2-3%, aggiunge deriva f16/hipBLASLt)
  export DS4_CUDA_SHARED_DOWN_CUBLAS="${DS4_CUDA_SHARED_DOWN_CUBLAS:-0}"  # Tier3: pruned (marginale ~2-3%, aggiunge deriva f16/hipBLASLt)
  export DS4_CUDA_ATTENTION_OUTPUT_CUBLAS_ALL="${DS4_CUDA_ATTENTION_OUTPUT_CUBLAS_ALL:-0}"  # Tier3: pruned (marginale ~2-3%, aggiunge deriva f16/hipBLASLt)
