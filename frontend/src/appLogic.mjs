...
export const AGENT_COMMANDS = [
  ...
  { name: "/debug start", desc: "Attach a debug frame to each agent turn" },
  { name: "/debug stop", desc: "Stop attaching debug frames" },
  { name: "/debug status", desc: "Show whether debug frames are attached" },
